# Automacao-de-processos-OutLook
# Automação de Indicadores

### Objetivo: Desenvolver um Projeto Completo que envolva a automatização de um processo/rotina de escritório.
